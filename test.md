...
* aarch64: Failed to repair the gicv2 default kernel 
* aarch64: Fix aarch64 smp startup failure 
* aarch64: Support hardware atomic
* aarch64: Fixup fpu storage's size in stack and append Q16 ~ Q31 
* aarch64: Fixup HW atomic_t ops type from dword to qword 
* aarch64: Support public linker scripts 
* aarch64: Change aarch64 trap backtrace & coredump priority rating 
* aarch64: Fixed an issue where AARCH64 Qemu failed to compile when SMP was disabled 
* arm: Fixed IAR compilation warnings: function "__LDREX" declared implicitly 
* arm: Modified start_gcc.S 
* arm: fix race condition with ldrex,strex 
